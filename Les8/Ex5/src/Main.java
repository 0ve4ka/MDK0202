...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        */
        if (checkChatCommand(commandValue))
        switch(ChatCommand.valueOf(commandValue)) {
            ...
            case BONUS:
                ...
                if (benefits < 10)
                    ...
                    benefits *= 15;
                System.out.println("Количество бонусных баллов: " + benefits);
                break;
        }
        else
            System.out.println("Команды " + commandValue + " не существует!");
...
public static boolean checkChatCommand(String command){
         boolean flag = false;
         for(ChatCommand com: ChatCommand.values()){
             if(com.toString().equals(command))
                 flag = true;
         }
         return flag;
}
